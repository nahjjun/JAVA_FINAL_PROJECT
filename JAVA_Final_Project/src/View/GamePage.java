...
public class GamePage extends JPanel {
    ...
    public GamePage(Model model, View view, Controller controller) {
        try {
            ...
            remainEnemyLabel.setLocation(650,10);
            ...
            userInterfacePanel_NORTH.setLayout(new FlowLayout());
    ...
    private void setDifficulty() {
    	...
    	int remainEnemyNum = model.getRemainEnemyNum();
    	switch(currentStage) {
    	case 1:
    		model.setRemainEnemyNum(50);
    		model.setEnemyAddTime(1000);
    		break;
    	case 2:
 ...
 // 벽의 개수를 최신화함과 동시에, readyPage에 있는 남은 벽의 개수도 갱신
 	public void updateRemainEnemyNum() {
